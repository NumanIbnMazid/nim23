...
import BackgroundAVIF from '@/assets/images/background.webp'
import DarkBackgroundImage from '@/assets/images/dark-background-image.png'
import DarkBackgroundAVIF from '@/assets/images/dark-background.webp'

export default function LayoutAppMain({ children }: { children: React.ReactNode }) {
