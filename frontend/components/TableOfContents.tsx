      ...
      {tableOfContents.length > 0 && (
        <>
          <div
            ...
            } md:left-0 md:opacity-100 md:max-w-[30%] lg:max-w-[30%]  transition-all duration-500 flex flex-col gap-1 !pb-[100px] overflow-y-scroll p-10 md:p-14 h-screen fixed w-full font-barlow bg-darkWhite dark:bg-darkPrimary text-neutral-800 dark:text-gray-200 z-50 `}
          >
            {/* TOC Search Bar */}
